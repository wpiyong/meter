...
namespace gUV.ViewModel
{
    class SettingsViewModel : ViewModelBase
    {
        ...
        string _measurementFolder, _textFilePath, _calDataTextFilePath, _metrologyFilePath, _fluorescenceTextFilePath;
        int _measurementImageType;
        bool _saveMeasurement, _extractToTextFile, _extractCalDataToTextFile, _extractFluorescenceDataToTextFile;
        ...
        double _shutterTimeMs, _shutterTimeDiffMs, _cameraTempDiffMs, _aDiffMs, _bDiffMs;

        double _lconv, _aconv, _bconv, _lshift, _ashift, _bshift;

        bool _flourescenceMeasure, _enableWBAdjustment;
        double _fShutterTimeMs, _fShutterTimeDiffMs, _gain;
        double _fLowShutterTimeMs, _flThreshold, _lowGain;
        uint _fluorescenceSetCurrent;
        uint _mainLightSetCurrent;
        int _uvWarningThreshold, _uvWarningThresholdHigh;
        ...
        public bool MeasureFluorescence
        {
            get { return _flourescenceMeasure; }
            set
            {
                _flourescenceMeasure = value;
                OnPropertyChanged("MeasureFluorescence");
            }
        }
        public bool EnableWBAdjustment
        {
            get { return _enableWBAdjustment; }
            set
            {
                _enableWBAdjustment = value;
                OnPropertyChanged("EnableWBAdjustment");
            }
        }
        ...
        public string FluorescenceTextFilePath
        {
            get { return _fluorescenceTextFilePath; }
            set
            {
                _fluorescenceTextFilePath = value;
                OnPropertyChanged("FluorescenceTextFilePath");
            }
        }
        ...
        public bool ExtractFluorescenceDataToTextFile
        {
            get { return _extractFluorescenceDataToTextFile; }
            set
            {
                _extractFluorescenceDataToTextFile = value;
                OnPropertyChanged("ExtractFluorescenceDataToTextFile");
            }
        }
        ...
        public double FShutterTimeMs
        {
            get
            {
                return Math.Round(_fShutterTimeMs, 2);
            }
            set
            {
                _fShutterTimeMs = value;
                OnPropertyChanged("FShutterTimeMs");
            }
        }
        public double LowGain
        {
            get
            {
                return Math.Round(_lowGain, 2);
            }
            set
            {
                _lowGain = value;
                OnPropertyChanged("LowGain");
            }
        }
        public double LowFShutterTimeMs
        {
            get
            {
                return Math.Round(_fLowShutterTimeMs, 2);
            }
            set
            {
                _fLowShutterTimeMs = value;
                OnPropertyChanged("LowFShutterTimeMs");
            }
        }
        public double FLThreshold
        {
            get
            {
                return Math.Round(_flThreshold, 2);
            }
            set
            {
                _flThreshold = value;
                OnPropertyChanged("FLThreshold");
            }
        }
        public double FShutterTimeDiffMs
        {
            get
            {
                return Math.Round(_fShutterTimeDiffMs, 2);
            }
            set
            {
                _fShutterTimeDiffMs = value;
                OnPropertyChanged("FShutterTimeDiffMs");
            }
        }
        ...
        public uint FluorescenceSetCurrent
        {
            get
            {
                return _fluorescenceSetCurrent;
            }
            set
            {
                try
                {
                    if (value < 0 || value > LightControl.FLUORESCENCE_MAX_CURRENT) 
                        throw new Exception("");
                    _fluorescenceSetCurrent = value;
                    OnPropertyChanged("FluorescenceSetCurrent");
                }
                catch (Exception /*e*/)
                {
                    App.LogEntry.AddEntry("FluorescenceSetCurrent not changed, value must be between 0 and " + LightControl.FLUORESCENCE_MAX_CURRENT);
                }
            }
        }

        public uint MainLightSetCurrent
        {
            get
            {
                return _mainLightSetCurrent;
            }
            set
            {
                try
                {
                    if (value <= 0 || value > LightControl.MAINLIGHT_MAX_CURRENT)
                        throw new Exception("");
                    _mainLightSetCurrent = value;
                    OnPropertyChanged("MainLightSetCurrent");
                }
                catch (Exception /*e*/)
                {
                    App.LogEntry.AddEntry("MainLightSetCurrent not changed, value must be between 1 and " + LightControl.MAINLIGHT_MAX_CURRENT);
                }
            }
        }

        public int UVWarningThreshold
        {
            get
            {
                return _uvWarningThreshold;
            }
            set
            {
                try
                {
                    //if (value <= 0)
                    //    throw new Exception("");
                    _uvWarningThreshold = value;
                    OnPropertyChanged("UVWarningThreshold");
                }
                catch (Exception /*e*/)
                {
                    App.LogEntry.AddEntry("UVWarningThreshold not changed.");
                }
            }
        }

        public int UVWarningThresholdHigh
        {
            get
            {
                return _uvWarningThresholdHigh;
            }
            set
            {
                try
                {
                    //if (value <= 0)
                    //    throw new Exception("");
                    _uvWarningThresholdHigh = value;
                    OnPropertyChanged("UVWarningThresholdHigh");
                }
                catch (Exception /*e*/)
                {
                    App.LogEntry.AddEntry("UVWarningThresholdHigh not changed.");
                }
            }
        }
        ...
        public SettingsViewModel()
        {
            ...
            MeasureFluorescence = GlobalVariables.fluorescenceSettings.FluorescenceMeasure;
            EnableWBAdjustment = GlobalVariables.fluorescenceSettings.EnableWBAdjustment;
            Gain = GlobalVariables.fluorescenceSettings.Gain;
            FShutterTimeMs = GlobalVariables.fluorescenceSettings.FShutterTime;
            FShutterTimeDiffMs = GlobalVariables.fluorescenceSettings.FShutterTimeDiff;
            FluorescenceSetCurrent = GlobalVariables.fluorescenceSettings.FluorescenceSetCurrent;
            LowGain = GlobalVariables.fluorescenceSettings.LowGain;
            LowFShutterTimeMs = GlobalVariables.fluorescenceSettings.LowFShutterTime;
            FLThreshold = GlobalVariables.fluorescenceSettings.FLThreshold;
            MainLightSetCurrent = GlobalVariables.fluorescenceSettings.MainLightSetCurrent;
            UVWarningThreshold = GlobalVariables.fluorescenceSettings.UVWarningThreshold;
            UVWarningThresholdHigh = GlobalVariables.fluorescenceSettings.UVWarningThresholdHigh;

            ExtractFluorescenceDataToTextFile = GlobalVariables.fluorescenceSettings.ExtractFluorescenceDataToTextFile;
            FluorescenceTextFilePath = GlobalVariables.fluorescenceSettings.FluorescenceTextFilePath;
            ...
            try
            {
                ...
                if (selectedCalStoneArray.Length < 1)
                {
            ...
            CommandFluorescenceTextFilePath = new RelayCommand(param => this.SelectFluorescenceTextFilePath());
        ...
        public RelayCommand CommandFluorescenceTextFilePath { get; set; }
        ...
        void SelectFluorescenceTextFilePath()
        {
            System.Windows.Forms.FolderBrowserDialog folderBrowserDialog =
                    new System.Windows.Forms.FolderBrowserDialog();

            if (FluorescenceTextFilePath != null)
                folderBrowserDialog.SelectedPath = FluorescenceTextFilePath;

            if (folderBrowserDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                FluorescenceTextFilePath = folderBrowserDialog.SelectedPath;
            }
        }
        ...
        void UpdateSettings(object param)
        {
            ...
            if (GlobalVariables.fluorescenceSettings.ExtractFluorescenceDataToTextFile != _extractFluorescenceDataToTextFile)
            {
                App.LogEntry.AddEntry("Extract Fluorescence data to Text file changed from " + GlobalVariables.fluorescenceSettings.ExtractFluorescenceDataToTextFile
                    + " to " + _extractFluorescenceDataToTextFile);
                GlobalVariables.fluorescenceSettings.ExtractFluorescenceDataToTextFile = _extractFluorescenceDataToTextFile;
            }
            ...
            {
                if (_textFilePath.Length == 0 || System.IO.Directory.Exists(_textFilePath))
                {
            ...
            if (GlobalVariables.fluorescenceSettings.FluorescenceTextFilePath != _fluorescenceTextFilePath)
            {
                App.LogEntry.AddEntry("Fluorescence Text file path changed from " + GlobalVariables.fluorescenceSettings.FluorescenceTextFilePath
                    + " to " + _fluorescenceTextFilePath);
                GlobalVariables.fluorescenceSettings.FluorescenceTextFilePath = _fluorescenceTextFilePath;
            }

            if (Properties.Settings.Default.MetrologyFilePath != _metrologyFilePath)
            {
                if (_metrologyFilePath.Length == 0 || System.IO.Directory.Exists(_metrologyFilePath))
                {
            ...
            if (GlobalVariables.fluorescenceSettings.FluorescenceMeasure != _flourescenceMeasure)
            {
                App.LogEntry.AddEntry("Measure Fluorescence changed from " + GlobalVariables.fluorescenceSettings.FluorescenceMeasure
                    + " to " + _flourescenceMeasure);
                GlobalVariables.fluorescenceSettings.FluorescenceMeasure = _flourescenceMeasure;
            }
            if (GlobalVariables.fluorescenceSettings.EnableWBAdjustment != _enableWBAdjustment)
            {
                App.LogEntry.AddEntry("Enable WB Adjustment changed from " + GlobalVariables.fluorescenceSettings.EnableWBAdjustment
                    + " to " + _enableWBAdjustment);
                GlobalVariables.fluorescenceSettings.EnableWBAdjustment = _enableWBAdjustment;
            }
            if (GlobalVariables.fluorescenceSettings.FShutterTime != _fShutterTimeMs)
            {
                App.LogEntry.AddEntry("Fluorescence ShutterTime changed from " + GlobalVariables.fluorescenceSettings.FShutterTime
                    + " to " + _fShutterTimeMs);
                GlobalVariables.fluorescenceSettings.FShutterTime = _fShutterTimeMs;
            }
            if (GlobalVariables.fluorescenceSettings.FShutterTimeDiff != _fShutterTimeDiffMs)
            {
                App.LogEntry.AddEntry("Fluorescence ShutterTime diff changed from " + GlobalVariables.fluorescenceSettings.FShutterTimeDiff
                    + " to " + _fShutterTimeDiffMs);
                GlobalVariables.fluorescenceSettings.FShutterTimeDiff = _fShutterTimeDiffMs;
            }
            if (GlobalVariables.fluorescenceSettings.Gain != _gain)
            {
                App.LogEntry.AddEntry("Gain changed from " + GlobalVariables.fluorescenceSettings.Gain
                    + " to " + _gain);
                GlobalVariables.fluorescenceSettings.Gain = _gain;
            }

            if (GlobalVariables.fluorescenceSettings.LowFShutterTime != _fLowShutterTimeMs)
            {
                App.LogEntry.AddEntry("Fluorescence Low ShutterTime changed from " + GlobalVariables.fluorescenceSettings.LowFShutterTime
                    + " to " + _fLowShutterTimeMs);
                GlobalVariables.fluorescenceSettings.LowFShutterTime = _fLowShutterTimeMs;
            }
            if (GlobalVariables.fluorescenceSettings.FLThreshold != _flThreshold)
            {
                App.LogEntry.AddEntry("Fluorescence Gain Threshold changed from " + GlobalVariables.fluorescenceSettings.FLThreshold
                    + " to " + _flThreshold);
                GlobalVariables.fluorescenceSettings.FLThreshold = _flThreshold;
            }
            if (GlobalVariables.fluorescenceSettings.LowGain != _lowGain)
            {
                App.LogEntry.AddEntry("Low Gain changed from " + GlobalVariables.fluorescenceSettings.LowGain
                    + " to " + _lowGain);
                GlobalVariables.fluorescenceSettings.LowGain = _lowGain;
            }

            if (GlobalVariables.fluorescenceSettings.FluorescenceSetCurrent != _fluorescenceSetCurrent)
            {
                App.LogEntry.AddEntry("FluorescenceSetCurrent changed from " + GlobalVariables.fluorescenceSettings.FluorescenceSetCurrent
                    + " to " + _fluorescenceSetCurrent);
                GlobalVariables.fluorescenceSettings.FluorescenceSetCurrent = _fluorescenceSetCurrent;
                LightControl.SetFluorescenceLightCurrent(_fluorescenceSetCurrent);
            }

            if (GlobalVariables.fluorescenceSettings.MainLightSetCurrent != _mainLightSetCurrent)
            {
                App.LogEntry.AddEntry("MainLightSetCurrent changed from " + GlobalVariables.fluorescenceSettings.MainLightSetCurrent
                    + " to " + _mainLightSetCurrent);
                GlobalVariables.fluorescenceSettings.MainLightSetCurrent = _mainLightSetCurrent;
                LightControl.SetMainLightCurrent(_mainLightSetCurrent);
            }

            

            if (GlobalVariables.fluorescenceSettings.UVWarningThreshold != _uvWarningThreshold)
            {
                App.LogEntry.AddEntry("UVWarningThreshold changed from " + GlobalVariables.fluorescenceSettings.UVWarningThreshold
                    + " to " + _uvWarningThreshold);
                GlobalVariables.fluorescenceSettings.UVWarningThreshold = _uvWarningThreshold;
            }
            if (GlobalVariables.fluorescenceSettings.UVWarningThresholdHigh != _uvWarningThresholdHigh)
            {
                App.LogEntry.AddEntry("UVWarningThresholdHigh changed from " + 
                    GlobalVariables.fluorescenceSettings.UVWarningThresholdHigh
                    + " to " + _uvWarningThresholdHigh);
                GlobalVariables.fluorescenceSettings.UVWarningThresholdHigh = _uvWarningThresholdHigh;
            }
            ...
            GlobalVariables.gColorAppSettings.Save();
